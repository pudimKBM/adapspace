...
WHERE command.id_produit = product.id AND product.id_category = category.id;";
	...
	<div class="right-align">
		<a href="checkout"
			class='btn-large button-rounded waves-effect waves-light'> Check out

...
<?php
session_start();
if ($_SESSION['logged_in'] && $_SESSION['role'] != "client") {
    $idsess = $_SESSION['id'];
} else {
			...
			<div class="container">
						...
						<div class="col-sm-10">
							...
							<div class="">
								<div class="tab-pane active" id="tab1">
									<div class="">
										<a>Voce pode selecionar varios produtos e cores diferentes.
											Clique no produto e veja a magica acontecer:</a>
										<!--					      	<h3>Tee Styles</h3>-->
										<p>

											<img value="1" selected="selected" src="images/crew_front1.png"
												style="width: 100px" />
				...
				<div class="row">
					<div class="col-sm-6" id="tab2">
						<div class="">
							<h4>Adapt sua camisteta ao seu estilo</h4>
							...
							<div id="avatarlist">
								<img style="cursor: pointer;" class="img-polaroid"
									src="images/invisibleman.jpg"> <img style="cursor: pointer;"
									class="img-polaroid"
						...
						<div class="span6">
							<div align="center" style="min-height: 32px;">
								...
								<div id="shirtDiv" class="page"
									style="width: 530px; height: 630px; position: absolute; background-color: rgb(255, 255, 255);">
									<img id="tshirtFacing" src="images/crew_front1.png"></img>
									<div id="drawingArea"
